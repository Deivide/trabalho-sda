package sda.comunication.especification;

/**
 * Classe que contem as especificações estaticas utilizadas no modulo de
 * Comunicação
 */
public class Especification {
	...
	public static String RMI_NAME = "SDAService";
	...
	public static String REPOSITORY_PATH = "download/";
